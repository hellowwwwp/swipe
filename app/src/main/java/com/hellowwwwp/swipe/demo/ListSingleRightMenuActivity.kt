...
class ListSingleRightMenuActivity : AppCompatActivity() {

    private val viewBinding: ActivityListSingleRightMenuBinding by lazy {
        ActivityListSingleRightMenuBinding.inflate(layoutInflater)
    }
    ...
    private fun initView() {
        with(viewBinding) {
            rcvList.layoutManager = LinearLayoutManager(this@ListSingleRightMenuActivity)
    ...
    class MyAdapter : SwipeMenuItemRecycleListAdapter<MyItem, ViewHolder>(MyItem.comparator) {

        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
            val inflater = LayoutInflater.from(parent.context)
            val binding = LayoutSingleRightMenuItemViewBinding.inflate(inflater, parent, false)
        ...
        override fun findSwipeMenuLayout(holder: ViewHolder): SwipeMenuLayout? {
            if (holder is MyViewHolder) {
    ...
    class MyViewHolder(
        val viewBinding: LayoutSingleRightMenuItemViewBinding
